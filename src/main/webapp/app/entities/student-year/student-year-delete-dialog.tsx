...
export class StudentYearDeleteDialog extends React.Component<IStudentYearDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.studentYearEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="cmsApp.studentYear.delete.question" interpolate={{ id: studentYearEntity.id }}>
            Are you sure you want to delete this StudentYear?
          </Translate>
        </ModalBody>
        <ModalFooter>
