...
export class AuthorizedSignatoryDeleteDialog extends React.Component<IAuthorizedSignatoryDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.authorizedSignatoryEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="cmsApp.authorizedSignatory.delete.question" interpolate={{ id: authorizedSignatoryEntity.id }}>
            Are you sure you want to delete this AuthorizedSignatory?
          </Translate>
        </ModalBody>
        <ModalFooter>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(AuthorizedSignatoryDeleteDialog);
