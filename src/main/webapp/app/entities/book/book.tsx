            ...
            <tbody>
              {bookList.map((book, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={book.issueDate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={book.dueDate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{book.noOfCopiesAvailable}</td>
                  <td>{book.status}</td>
                  <td>
                    <TextFormat type="date" value={book.receivedDate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{book.studentId ? <Link to={`student/${book.studentId}`}>{book.studentId}</Link> : ''}</td>
                  <td>{book.libraryId ? <Link to={`library/${book.libraryId}`}>{book.libraryId}</Link> : ''}</td>
