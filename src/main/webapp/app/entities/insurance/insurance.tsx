...
import { getSearchEntities, getEntities } from './insurance.reducer';
...
export class Insurance extends React.Component<IInsuranceProps, IInsuranceState> {
  state: IInsuranceState = {
    search: ''
  };
      ...
      <div>
        <h2 id="insurance-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Insurance
          </Link>
        </h2>
        <Row>
          <Col sm="12">
            ...
            <tbody>
              {insuranceList.map((insurance, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={insurance.dateOfInsurance} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={insurance.validTill} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
