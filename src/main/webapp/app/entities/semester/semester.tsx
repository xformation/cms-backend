...
import { getSearchEntities, getEntities } from './semester.reducer';
...
export class Semester extends React.Component<ISemesterProps, ISemesterState> {
  state: ISemesterState = {
    search: ''
  };
  ...
  render() {
    const { semesterList, match } = this.props;
    return (
      <div>
        <h2 id="semester-heading">
          <Translate contentKey="cmsApp.semester.home.title">Semesters</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="cmsApp.semester.home.createLabel">Create new Semester</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('cmsApp.semester.home.search')}
                  />
            ...
            <tbody>
              {semesterList.map((semester, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`cmsApp.Sem.${semester.sem}`} />
                  </td>
