...
export class College extends React.Component<ICollegeProps, ICollegeState> {
  state: ICollegeState = {
    search: ''
  };
  ...
  render() {
    const { collegeList, match } = this.props;
    return (
      <div>
        <h2 id="college-heading">
          <Translate contentKey="cmsApp.college.home.title">Colleges</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="cmsApp.college.home.createLabel">Create new College</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('cmsApp.college.home.search')}
                  />
