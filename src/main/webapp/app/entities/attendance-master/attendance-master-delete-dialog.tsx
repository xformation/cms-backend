...
export class AttendanceMasterDeleteDialog extends React.Component<IAttendanceMasterDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.attendanceMasterEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="cmsApp.attendanceMaster.delete.question" interpolate={{ id: attendanceMasterEntity.id }}>
            Are you sure you want to delete this AttendanceMaster?
          </Translate>
        </ModalBody>
        <ModalFooter>
