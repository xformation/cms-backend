...
export interface ILegalEntityDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any }> {}
...
export class LegalEntityDeleteDialog extends React.Component<ILegalEntityDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.legalEntityEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="cmsApp.legalEntity.delete.question" interpolate={{ id: legalEntityEntity.id }}>
