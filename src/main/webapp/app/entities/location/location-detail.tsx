...
export interface ILocationDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="cmsApp.location.detail.title">Location</Translate> [<b>{locationEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{locationEntity.appliesTo}</dd>
          </dl>
