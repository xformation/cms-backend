...
export class AdminAttendanceDeleteDialog extends React.Component<IAdminAttendanceDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.adminAttendanceEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="cmsApp.adminAttendance.delete.question">Are you sure you want to delete this AdminAttendance?</ModalBody>
        <ModalFooter>
          <Button color="secondary" onClick={this.handleClose}>
            <FontAwesomeIcon icon="ban" />&nbsp; Cancel
          </Button>
          <Button id="jhi-confirm-delete-adminAttendance" color="danger" onClick={this.confirmDelete}>
