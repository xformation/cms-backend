...
export class TeachDeleteDialog extends React.Component<ITeachDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.teachEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="cmsApp.teach.delete.question" interpolate={{ id: teachEntity.id }}>
            Are you sure you want to delete this Teach?
          </Translate>
        </ModalBody>
        <ModalFooter>
