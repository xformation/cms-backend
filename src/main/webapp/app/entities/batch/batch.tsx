...
import { getSearchEntities, getEntities } from './batch.reducer';
import { IBatch } from 'app/shared/model/batch.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IBatchProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IBatchState {
  search: string;
}

export class Batch extends React.Component<IBatchProps, IBatchState> {
  state: IBatchState = {
    search: ''
  };
  ...
  render() {
    const { batchList, match } = this.props;
    return (
      <div>
        <h2 id="batch-heading">
          Batches
