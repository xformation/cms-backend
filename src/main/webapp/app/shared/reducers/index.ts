...
// prettier-ignore
import exceptionRecord, {
  ExceptionRecordState
} from 'app/entities/exception-record/exception-record.reducer';
// prettier-ignore
import paymentRequestResponse, {
  PaymentRequestResponseState
} from 'app/entities/payment-request-response/payment-request-response.reducer';
// prettier-ignore
...
export interface IRootState {
  ...
  readonly exceptionRecord: ExceptionRecordState;
  readonly paymentRequestResponse: PaymentRequestResponseState;
