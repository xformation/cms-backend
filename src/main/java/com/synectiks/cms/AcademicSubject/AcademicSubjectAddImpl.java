...
@Repository
public class AcademicSubjectAddImpl {

    @PersistenceContext
    private EntityManager entityManager;

    @Transactional
    public List<AcademicSubjectVo> addAcademicSubjectData(AddAcademicSubjectInputPayload addAcademicSubjectInputPayload) throws JSONException, ParseException {
        String[] subjectData = addAcademicSubjectInputPayload.getSubjectData();
       ...
       return (List<AcademicSubjectVo>) addAcademicSubjectInputPayload;
    }
}
