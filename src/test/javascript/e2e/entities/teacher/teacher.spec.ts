...
describe('Teacher e2e test', () => {
  ...
  it('should create and save Teachers', async () => {
    ...
    await teacherUpdatePage.setSpouseNameInput('spouseName');
    expect(await teacherUpdatePage.getSpouseNameInput()).to.match(/spouseName/);
    await teacherUpdatePage.setSpouseMiddleNameInput('spouseMiddleName');
    expect(await teacherUpdatePage.getSpouseMiddleNameInput()).to.match(/spouseMiddleName/);
    await teacherUpdatePage.setSpouseLastNameInput('spouseLastName');
    ...
    await teacherUpdatePage.setTeacherContactNumberInput('teacherContactNumber');
    expect(await teacherUpdatePage.getTeacherContactNumberInput()).to.match(/teacherContactNumber/);
    await teacherUpdatePage.setAlternateContactNumberInput('alternateContactNumber');
    ...
    await teacherUpdatePage.setEmergencyContactNameInput('emergencyContactName');
    expect(await teacherUpdatePage.getEmergencyContactNameInput()).to.match(/emergencyContactName/);
    await teacherUpdatePage.setEmergencyContactMiddleNameInput('emergencyContactMiddleName');
    expect(await teacherUpdatePage.getEmergencyContactMiddleNameInput()).to.match(/emergencyContactMiddleName/);
    await teacherUpdatePage.setEmergencyContactLastNameInput('emergencyContactLastName');
    expect(await teacherUpdatePage.getEmergencyContactLastNameInput()).to.match(/emergencyContactLastName/);
    await teacherUpdatePage.setEmergencyContactNoInput('emergencyContactNo');
    expect(await teacherUpdatePage.getEmergencyContactNoInput()).to.match(/emergencyContactNo/);
    await teacherUpdatePage.setEmergencyContactEmailAddressInput('emergencyContactEmailAddress');
