...
describe('Holiday e2e test', () => {
  ...
  it('should create and save Holidays', async () => {
    ...
    await holidayUpdatePage.setSrNoInput('5');
    expect(await holidayUpdatePage.getSrNoInput()).to.eq('5');
    await holidayUpdatePage.setSHolidayInput('sHoliday');
    expect(await holidayUpdatePage.getSHolidayInput()).to.match(/sHoliday/);
    await holidayUpdatePage.setADateInput('01-01-2001');
    expect(await holidayUpdatePage.getADateInput()).to.eq('2001-01-01');
    await holidayUpdatePage.statusSelectLastOption();
