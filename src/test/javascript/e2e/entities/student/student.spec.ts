...
describe('Student e2e test', () => {
  ...
  /* it('should create and save Students', async () => {
        ...
        await studentUpdatePage.setReligionInput('religion');
        expect(await studentUpdatePage.getReligionInput()).to.match(/religion/);
        await studentUpdatePage.setCasteInput('caste');
        expect(await studentUpdatePage.getCasteInput()).to.match(/caste/);
        ...
        await studentUpdatePage.setBloodGroupInput('bloodGroup');
        expect(await studentUpdatePage.getBloodGroupInput()).to.match(/bloodGroup/);
        ...
        await studentUpdatePage.setRelationWithStudentInput('relationWithStudent');
        expect(await studentUpdatePage.getRelationWithStudentInput()).to.match(/relationWithStudent/);
        ...
        await studentUpdatePage.setStudentTypeInput('studentType');
        expect(await studentUpdatePage.getStudentTypeInput()).to.match(/studentType/);
