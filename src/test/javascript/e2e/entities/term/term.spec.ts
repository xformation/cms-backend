...
describe('Term e2e test', () => {
  ...
  it('should create and save Terms', async () => {
    ...
    await termUpdatePage.setSrNoInput('5');
    expect(await termUpdatePage.getSrNoInput()).to.eq('5');
    await termUpdatePage.setATermsInput('aTerms');
    expect(await termUpdatePage.getATermsInput()).to.match(/aTerms/);
    ...
    await termUpdatePage.statusSelectLastOption();
