...
/**
 * Performance test for the BankAccounts entity.
 */
class BankAccountsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BankAccounts entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created bankAccounts")
                .get("${new_bankAccounts_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created bankAccounts")
            .delete("${new_bankAccounts_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
