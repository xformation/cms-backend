...
/**
 * Integration tests for the {@Link StudentAttendanceResource} REST controller.
 */
@SpringBootTest(classes = CmsApp.class)
public class StudentAttendanceResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static StudentAttendance createUpdatedEntity(EntityManager em) {
        StudentAttendance studentAttendance = new StudentAttendance()
