...
//        student.setBranch(branch);
    ...
    public void searchStudent() throws Exception {
        ...
        studentRepository.saveAndFlush(student);
		/*
		 * when(mockStudentSearchRepository.search(queryStringQuery("id:" +
		 * student.getId()))) .thenReturn(Collections.singletonList(student));
		 * // Search the student
		 * restStudentMockMvc.perform(get("/api/_search/students?query=id:" +
		 * student.getId())) .andExpect(status().isOk())
		 * .andExpect(content().contentType(MediaType.
		 * APPLICATION_JSON_UTF8_VALUE))
		 * .andExpect(jsonPath("$.[*].id").value(hasItem(student.getId().
		 * intValue()))) .andExpect(jsonPath("$.[*].studentName").value(hasItem(
		 * DEFAULT_STUDENT_NAME)))
		 * .andExpect(jsonPath("$.[*].studentMiddleName").value(hasItem(
		 * DEFAULT_STUDENT_MIDDLE_NAME)))
		 * .andExpect(jsonPath("$.[*].studentLastName").value(hasItem(
		 * DEFAULT_STUDENT_LAST_NAME)))
		 * .andExpect(jsonPath("$.[*].fatherName").value(hasItem(
		 * DEFAULT_FATHER_NAME)))
		 * .andExpect(jsonPath("$.[*].fatherMiddleName").value(hasItem(
		 * DEFAULT_FATHER_MIDDLE_NAME)))
		 * .andExpect(jsonPath("$.[*].fatherLastName").value(hasItem(
		 * DEFAULT_FATHER_LAST_NAME)))
		 * .andExpect(jsonPath("$.[*].motherName").value(hasItem(
		 * DEFAULT_MOTHER_NAME)))
		 * .andExpect(jsonPath("$.[*].motherMiddleName").value(hasItem(
		 * DEFAULT_MOTHER_MIDDLE_NAME)))
		 * .andExpect(jsonPath("$.[*].motherLastName").value(hasItem(
		 * DEFAULT_MOTHER_LAST_NAME)))
		 * .andExpect(jsonPath("$.[*].studentAadharNo").value(hasItem(
		 * DEFAULT_STUDENT_AADHAR_NO)))
		 * .andExpect(jsonPath("$.[*].studentPanNo").value(hasItem(
		 * DEFAULT_STUDENT_PAN_NO)))
		 * .andExpect(jsonPath("$.[*].studentSocialSecurityNo").value(hasItem(
		 * DEFAULT_STUDENT_SOCIAL_SECURITY_NO)))
		 * .andExpect(jsonPath("$.[*].studentTaxReferenceNo").value(hasItem(
		 * DEFAULT_STUDENT_TAX_REFERENCE_NO)))
		 * .andExpect(jsonPath("$.[*].studentBplNo").value(hasItem(
		 * DEFAULT_STUDENT_BPL_NO)))
		 * .andExpect(jsonPath("$.[*].studentDrivingLicenseNo").value(hasItem(
		 * DEFAULT_STUDENT_DRIVING_LICENSE_NO)))
		 * .andExpect(jsonPath("$.[*].studentPassportNo").value(hasItem(
		 * DEFAULT_STUDENT_PASSPORT_NO)))
		 * .andExpect(jsonPath("$.[*].dateOfBirth").value(hasItem(
		 * DEFAULT_DATE_OF_BIRTH.toString())))
		 * .andExpect(jsonPath("$.[*].placeOfBirth").value(hasItem(
		 ...
		 * ))) .andExpect(jsonPath("$.[*].age").value(hasItem(DEFAULT_AGE)))
		 * .andExpect(jsonPath("$.[*].sex").value(hasItem(DEFAULT_SEX.toString()
		 * ))) .andExpect(jsonPath("$.[*].studentLocalAddress").value(hasItem(
		 * DEFAULT_STUDENT_LOCAL_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].studentPermanentAddress").value(hasItem(
		 * DEFAULT_STUDENT_PERMANENT_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].city").value(hasItem(DEFAULT_CITY)))
		 * .andExpect(jsonPath("$.[*].state").value(hasItem(DEFAULT_STATE)))
		 * .andExpect(jsonPath("$.[*].country").value(hasItem(DEFAULT_COUNTRY)))
		 * .andExpect(jsonPath("$.[*].pinCode").value(hasItem(DEFAULT_PIN_CODE))
		 * )
		 * .andExpect(jsonPath("$.[*].studentPrimaryCellNumber").value(hasItem(
		 * DEFAULT_STUDENT_PRIMARY_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].studentAlternateCellNumber").value(hasItem
		 * (DEFAULT_STUDENT_ALTERNATE_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].studentLandLinePhoneNumber").value(hasItem
		 * (DEFAULT_STUDENT_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].studentPrimaryEmailId").value(hasItem(
		 * DEFAULT_STUDENT_PRIMARY_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].studentAlternateEmailId").value(hasItem(
		 * DEFAULT_STUDENT_ALTERNATE_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].relationWithStudent").value(hasItem(
		 * DEFAULT_RELATION_WITH_STUDENT.toString())))
		 * .andExpect(jsonPath("$.[*].emergencyContactName").value(hasItem(
		 * DEFAULT_EMERGENCY_CONTACT_NAME)))
		 * .andExpect(jsonPath("$.[*].emergencyContactMiddleName").value(hasItem
		 * (DEFAULT_EMERGENCY_CONTACT_MIDDLE_NAME)))
		 * .andExpect(jsonPath("$.[*].emergencyContactLastName").value(hasItem(
		 * DEFAULT_EMERGENCY_CONTACT_LAST_NAME)))
		 * .andExpect(jsonPath("$.[*].emergencyContactCellNumber").value(hasItem
		 * (DEFAULT_EMERGENCY_CONTACT_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].emergencyContactLandLinePhoneNumber").
		 * value(hasItem(DEFAULT_EMERGENCY_CONTACT_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].emergencyContactEmailId").value(hasItem(
		 * DEFAULT_EMERGENCY_CONTACT_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].studentImagePath").value(hasItem(
		 * DEFAULT_STUDENT_IMAGE_PATH)))
		 * .andExpect(jsonPath("$.[*].admissionNo").value(hasItem(
		 * DEFAULT_ADMISSION_NO)))
		 * .andExpect(jsonPath("$.[*].enrollmentNo").value(hasItem(
		 * DEFAULT_ENROLLMENT_NO)))
		 * .andExpect(jsonPath("$.[*].rollNo").value(hasItem(DEFAULT_ROLL_NO)))
		 * .andExpect(jsonPath("$.[*].studentType").value(hasItem(
		 * DEFAULT_STUDENT_TYPE.toString())))
		 * .andExpect(jsonPath("$.[*].fatherCellNumber").value(hasItem(
		 * DEFAULT_FATHER_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].fatherEmailId").value(hasItem(
		 * DEFAULT_FATHER_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].fatherOccupation").value(hasItem(
		 * DEFAULT_FATHER_OCCUPATION)))
		 * .andExpect(jsonPath("$.[*].fatherOfficeEmailId").value(hasItem(
		 * DEFAULT_FATHER_OFFICE_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].fatherOfficeAddress").value(hasItem(
		 * DEFAULT_FATHER_OFFICE_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].fatherOfficeCellNumber").value(hasItem(
		 * DEFAULT_FATHER_OFFICE_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].fatherOfficeLandLinePhoneNumber").value(
		 * hasItem(DEFAULT_FATHER_OFFICE_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].fatherAadharNo").value(hasItem(
		 * DEFAULT_FATHER_AADHAR_NO)))
		 * .andExpect(jsonPath("$.[*].fatherPanNo").value(hasItem(
		 * DEFAULT_FATHER_PAN_NO)))
		 * .andExpect(jsonPath("$.[*].fatherSocialSecurityNo").value(hasItem(
		 * DEFAULT_FATHER_SOCIAL_SECURITY_NO)))
		 * .andExpect(jsonPath("$.[*].fatherTaxReferenceNo").value(hasItem(
		 * DEFAULT_FATHER_TAX_REFERENCE_NO)))
		 * .andExpect(jsonPath("$.[*].fatherBplNo").value(hasItem(
		 * DEFAULT_FATHER_BPL_NO)))
		 * .andExpect(jsonPath("$.[*].fatherDrivingLicenseNo").value(hasItem(
		 * DEFAULT_FATHER_DRIVING_LICENSE_NO)))
		 * .andExpect(jsonPath("$.[*].fatherPassportNo").value(hasItem(
		 * DEFAULT_FATHER_PASSPORT_NO)))
		 * .andExpect(jsonPath("$.[*].fatherImagePath").value(hasItem(
		 * DEFAULT_FATHER_IMAGE_PATH)))
		 * .andExpect(jsonPath("$.[*].motherCellNumber").value(hasItem(
		 * DEFAULT_MOTHER_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].motherEmailId").value(hasItem(
		 * DEFAULT_MOTHER_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].motherOccupation").value(hasItem(
		 * DEFAULT_MOTHER_OCCUPATION)))
		 * .andExpect(jsonPath("$.[*].motherOfficeEmailId").value(hasItem(
		 * DEFAULT_MOTHER_OFFICE_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].motherOfficeAddress").value(hasItem(
		 * DEFAULT_MOTHER_OFFICE_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].motherOfficeCellNumber").value(hasItem(
		 * DEFAULT_MOTHER_OFFICE_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].motherOfficeLandLinePhoneNumber").value(
		 * hasItem(DEFAULT_MOTHER_OFFICE_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].motherAadharNo").value(hasItem(
		 * DEFAULT_MOTHER_AADHAR_NO)))
		 * .andExpect(jsonPath("$.[*].motherPanNo").value(hasItem(
		 * DEFAULT_MOTHER_PAN_NO)))
		 * .andExpect(jsonPath("$.[*].motherSocialSecurityNo").value(hasItem(
		 * DEFAULT_MOTHER_SOCIAL_SECURITY_NO)))
		 * .andExpect(jsonPath("$.[*].motherTaxReferenceNo").value(hasItem(
		 * DEFAULT_MOTHER_TAX_REFERENCE_NO)))
		 * .andExpect(jsonPath("$.[*].motherBplNo").value(hasItem(
		 * DEFAULT_MOTHER_BPL_NO)))
		 * .andExpect(jsonPath("$.[*].motherDrivingLicenseNo").value(hasItem(
		 * DEFAULT_MOTHER_DRIVING_LICENSE_NO)))
		 * .andExpect(jsonPath("$.[*].motherPassportNo").value(hasItem(
		 * DEFAULT_MOTHER_PASSPORT_NO)))
		 * .andExpect(jsonPath("$.[*].motherImagePath").value(hasItem(
		 * DEFAULT_MOTHER_IMAGE_PATH)))
		 * .andExpect(jsonPath("$.[*].guardianName").value(hasItem(
		 * DEFAULT_GUARDIAN_NAME)))
		 * .andExpect(jsonPath("$.[*].guardianMiddleName").value(hasItem(
		 * DEFAULT_GUARDIAN_MIDDLE_NAME)))
		 * .andExpect(jsonPath("$.[*].guardianLastName").value(hasItem(
		 * DEFAULT_GUARDIAN_LAST_NAME)))
		 * .andExpect(jsonPath("$.[*].guardianAddress").value(hasItem(
		 * DEFAULT_GUARDIAN_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].guardianCellNumber").value(hasItem(
		 * DEFAULT_GUARDIAN_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].guardianLandLinePhoneNumber").value(
		 * hasItem(DEFAULT_GUARDIAN_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].guardianEmailId").value(hasItem(
		 * DEFAULT_GUARDIAN_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].guardianOccupation").value(hasItem(
		 * DEFAULT_GUARDIAN_OCCUPATION)))
		 * .andExpect(jsonPath("$.[*].guardianOfficeEmailId").value(hasItem(
		 * DEFAULT_GUARDIAN_OFFICE_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].guardianOfficeAddress").value(hasItem(
		 * DEFAULT_GUARDIAN_OFFICE_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].guardianOfficeCellNumber").value(hasItem(
		 * DEFAULT_GUARDIAN_OFFICE_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].guardianOfficeLandLinePhoneNumber").value(
		 * hasItem(DEFAULT_GUARDIAN_OFFICE_LAND_LINE_PHONE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].guardianImagePath").value(hasItem(
		 * DEFAULT_GUARDIAN_IMAGE_PATH)))
		 * .andExpect(jsonPath("$.[*].isGuardianSponsorAgency").value(hasItem(
		 * DEFAULT_IS_GUARDIAN_SPONSOR_AGENCY)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyName").value(hasItem(
		 * DEFAULT_SPONSOR_AGENCY_NAME)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyRegistrationNo").value(
		 * hasItem(DEFAULT_SPONSOR_AGENCY_REGISTRATION_NO)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAddress").value(hasItem(
		 * DEFAULT_SPONSOR_AGENCY_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyCellNumber").value(hasItem(
		 * DEFAULT_SPONSOR_AGENCY_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyLandLineNumber").value(
		 * hasItem(DEFAULT_SPONSOR_AGENCY_LAND_LINE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyEmailId").value(hasItem(
		 * DEFAULT_SPONSOR_AGENCY_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeName").value(hasItem
		 * (DEFAULT_SPONSOR_AGENCY_APPOINTEE_NAME)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeDesignation").value(
		 * hasItem(DEFAULT_SPONSOR_AGENCY_APPOINTEE_DESIGNATION)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeCellNumber").value(
		 * hasItem(DEFAULT_SPONSOR_AGENCY_APPOINTEE_CELL_NUMBER)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeLandLineNumber").
		 * value(hasItem(DEFAULT_SPONSOR_AGENCY_APPOINTEE_LAND_LINE_NUMBER)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeEmailId").value(
		 * hasItem(DEFAULT_SPONSOR_AGENCY_APPOINTEE_EMAIL_ID)))
		 * .andExpect(jsonPath("$.[*].sponsorAgencyAppointeeOfficeAddress").
		 * value(hasItem(DEFAULT_SPONSOR_AGENCY_APPOINTEE_OFFICE_ADDRESS)))
		 * .andExpect(jsonPath("$.[*].isPhysicallyChallenged").value(hasItem(
		 * DEFAULT_IS_PHYSICALLY_CHALLENGED)))
		 * .andExpect(jsonPath("$.[*].detailsOfDisability").value(hasItem(
		 * DEFAULT_DETAILS_OF_DISABILITY)))
		 * .andExpect(jsonPath("$.[*].disabilityCertificateNo").value(hasItem(
		 * DEFAULT_DISABILITY_CERTIFICATE_NO)))
		 * .andExpect(jsonPath("$.[*].disabilityCertificateIssueAuthority").
		 * value(hasItem(DEFAULT_DISABILITY_CERTIFICATE_ISSUE_AUTHORITY)))
		 * .andExpect(jsonPath("$.[*].disabilityCertificateIssueDate").value(
		 * hasItem(DEFAULT_DISABILITY_CERTIFICATE_ISSUE_DATE.toString())))
		 * .andExpect(jsonPath("$.[*].percentagOfDisability").value(hasItem(
		 * DEFAULT_PERCENTAG_OF_DISABILITY)))
		 * .andExpect(jsonPath("$.[*].bloodGroup").value(hasItem(
		 * DEFAULT_BLOOD_GROUP.toString())))
		 * .andExpect(jsonPath("$.[*].vaccinationDetails").value(hasItem(
		 * DEFAULT_VACCINATION_DETAILS)))
		 * .andExpect(jsonPath("$.[*].otherMedicalDetails").value(hasItem(
		 * DEFAULT_OTHER_MEDICAL_DETAILS)))
		 * .andExpect(jsonPath("$.[*].status").value(hasItem(DEFAULT_STATUS.
		 * toString()))) .andExpect(jsonPath("$.[*].createdBy").value(hasItem(
		 * DEFAULT_CREATED_BY)))
		 * .andExpect(jsonPath("$.[*].createdOn").value(hasItem(
		 * DEFAULT_CREATED_ON.toString())))
		 * .andExpect(jsonPath("$.[*].updatedBy").value(hasItem(
		 * DEFAULT_UPDATED_BY)))
		 * .andExpect(jsonPath("$.[*].updatedOn").value(hasItem(
		 * DEFAULT_UPDATED_ON.toString())))
